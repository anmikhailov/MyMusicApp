...
class ThirdScreenOnboardingVC: UIViewController {
    ...
    private let mockImageView: UIImageView = {
        ...
        image.image = UIImage(named: "third screen back")
        return image
    }()
    ...
    @objc func nextScreen(_ sender: UIButton) {
        let vc = FourthScreenOnboardingVC()
        vc.modalPresentationStyle = .fullScreen
        present(vc, animated: true)
//        self.navigationController?.pushViewController(FourthScreenOnboardingVC(), animated: true)
    }
}

extension ThirdScreenOnboardingVC {
    ...
    func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            appNameLabel.topAnchor.constraint(equalTo: view.topAnchor, constant: 430),
